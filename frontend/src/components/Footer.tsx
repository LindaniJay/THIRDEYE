...
const Footer: React.FC = () => {
  return (
    <footer className="bg-gray-900 text-gray-300 py-1 px-1 w-full shadow-lg text-[10px] leading-tight">
      <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-1">
        {/* Brand / About */}
        <div>
          <h2 className="text-sm font-bold text-white mb-1">My Company</h2>
          <p className="text-[10px]">
            We provide reliable services with a focus on quality, trust, and
        ...
        {/* Contact Info */}
        <div>
          <h2 className="text-sm font-bold text-white mb-1">Contact Us</h2>
          <ul className="space-y-1 text-[10px]">
            <li className="flex items-center gap-3">
              <LocationIcon className="text-blue-400 h-3 w-3" /> 123 Main Street, Durban
            </li>
            <li className="flex items-center gap-3">
              <PhoneIcon className="text-blue-400 h-3 w-3" /> +27 69 215 1207
            </li>
            <li className="flex items-center gap-3">
              <EnvelopeIcon className="text-blue-400 h-3 w-3" /> lindanijonase@gmail.com
            </li>
          </ul>
        </div>
      ...
      {/* Bottom Bar */}
      <div className="mt-2 border-t border-gray-700 pt-1 text-center text-[10px]">
